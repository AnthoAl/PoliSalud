...
public class LayoutEjemplos {
    ...
    private PatLabel  
            lblTitulo = new PatLabel("Cita"          ), //, Color.BLACK, new Font("MesloLGL Nerd Font", Font.BOLD ,  20)),
            lblIdCita = new PatLabel("Codigo:      " ),
            lblNombre = new PatLabel("Descripción: " ),
            lblTotalReg=new PatLabel("  0 de 0  "    );
    private TextField  
            txtIdCita = new TextField (" ",20),
    ...
    private void  addControls(){
        ...
        lblIdCita.setFont(fontPanel); 
        lblNombre.setFont(fontPanel); 
        lblTotalReg.setFont(fontPanel); 

        txtIdCita.setFont(fontPanel); 
        txtNombre.setFont(fontPanel); 
        txtIdCita.setEditable( false );
        txtIdCita.setForeground (Color.darkGray);
        ...
        gbc.gridy = 1;          // Fila : 1
        pnl.add(lblIdCita,  gbc);   // gbc.gridx = 0;
        pnl.add(txtIdCita,  gbc);   // gbc.gridx = 1;
